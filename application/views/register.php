             ...
             <div class="col-lg-6">
                 <form method="post">
                     <div class="mb-3">
                         ...
                         <input type="text" class="form-control" name="fio" id="fio" aria-describedby="fio" required>
                     </div>
                     <div class="mb-3">
                     ...
                     <div class="mb-3">
                         ...
                         <input type="password" class="form-control" name="passwordu" id="pass" required>
                     </div>
                     <div class="mb-3">
                         <label for="passwordu1" class="form-label">Повторить пароль</label>
                         <input type="password" class="form-control" name="passwordu1" id="pas" required>
                         <p id="err"></p>
                     </div>
                     <div class="mb-3">
                         <input class="form-check-input" type="checkbox" value="" id="cogl">
